 ...
 */
@Entity
@GraphQLObjectType("TopicPage")
// @Transactional
@SuppressWarnings("unused")
public class TopicPage implements IBaseEntityPage<Topic> {
	...
	public static class Builder {
		 ...
		 * The requested pageful of records.
		 */
		public Builder withContent(List<Topic> contentParam) {
		...
		public TopicPage build() {
			TopicPage _object = new TopicPage();
