...
public class DeclarationController {
	...
	/**
	 * Loads the data for Declaration.entityKind. It returns an Object: the data fetcher implementation may
	...
	public Object entityKind(DataFetchingEnvironment dataFetchingEnvironment, Declaration origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateDeclaration.entityKind(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}

	/**
	 * Loads the data for Declaration.status. It returns an Object: the data fetcher implementation may
	 * return any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	...
	/**
	 * Loads the data for Declaration.createdByUser. It is generated as the
	...
	/**
	 * Loads the data for Declaration.updatedByUser. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environment for this batch loader. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	...
	/**
	 * Loads the data for Declaration.log. It returns an Object: the data fetcher implementation may return
	...
	/**
	 * This method loads the data for Declaration.comments. It returns an Object: the data fetcher implementation may return
	 * any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param dataLoader The {@link DataLoader} allows to load several data in one query. It allows to solve the (n+1)
	...
	public Object comments(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, CommentPage> dataLoader,
		Declaration origin, @Argument("filter") CommentQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateDeclaration.comments(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}

	/**
	 * Loads the data for Declaration.fromEntityLinks. It returns an Object: the data fetcher implementation
	 * may return any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param dataLoader The {@link DataLoader} allows to load several data in one query. It allows to solve the (n+1)
	 * queries issues, and greatly optimizes the response time.<BR/>
	...
	public Object fromEntityLinks(DataFetchingEnvironment dataFetchingEnvironment,
		DataLoader<Long, EntityLinkPage> dataLoader, Declaration origin,
		@Argument("filter") LinkableEntityQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateDeclaration.fromEntityLinks(dataFetchingEnvironment, dataLoader, origin, filter,
			pageSort);
	}

	/**
	 * Loads the data for Declaration.toEntityLinks. It returns an Object: the data fetcher implementation
	 * may return any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param dataLoader The {@link DataLoader} allows to load several data in one query. It allows to solve the (n+1)
	...
	public Object toEntityLinks(DataFetchingEnvironment dataFetchingEnvironment,
		...
		return this.dataFetchersDelegateDeclaration.toEntityLinks(dataFetchingEnvironment, dataLoader, origin, filter,
			pageSort);
	}

	/**
	 * Loads the data for Declaration.kind. It returns an Object: the data fetcher implementation may return
	 * any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	...
	/**
	 * Loads the data for Declaration.country. It returns an Object: the data fetcher implementation may
	 * return any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
