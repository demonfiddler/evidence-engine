 ...
 */
@Controller
@SchemaMapping(typeName = "LinkAudit")
public class LinkAuditController {

	protected final DataFetchersDelegateLinkAudit dataFetchersDelegateLinkAudit;
	protected GraphqlServerUtils graphqlServerUtils;

	public LinkAuditController(DataFetchersDelegateLinkAudit dataFetchersDelegateLinkAudit,
		GraphqlServerUtils graphqlServerUtils) {

		this.dataFetchersDelegateLinkAudit = dataFetchersDelegateLinkAudit;
	...
	public Map<LinkAudit, List<LinkAuditEntry>> links(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateLinkAudit.links(batchLoaderEnvironment, graphQLContext, keys);
	}

	/**
	 * This methods loads the data for ${dataFetcher.graphQLType}.groups. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environement for this batch loaded. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	 * @param keys The objects for which the value for the groups field must be retrieved.
	 * @return This method returns <code>${dataFetcher.batchMappingReturnType.value}</code>, as defined by the
	 * <code>batchMappingDataFetcherReturnType</code> plugin parameter. <br/>
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	...
	public Map<LinkAudit, List<LinkGroupAuditEntry>> groups(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateLinkAudit.groups(batchLoaderEnvironment, graphQLContext, keys);
	}
