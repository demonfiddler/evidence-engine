 ...
 */
@Entity
@GraphQLObjectType("UserPage")
// @Transactional
@SuppressWarnings("unused")
public class UserPage implements IBaseEntityPage<User> {
	 ...
	 */
	@Transient
	@GraphQLNonScalar(fieldName = "content", graphQLTypeSimpleName = "User", javaClass = User.class, listDepth = 1)
	List<User> content;
	...
	public static class Builder {
		 ...
		 * The requested pageful of records.
		 */
		public Builder withContent(List<User> contentParam) {
