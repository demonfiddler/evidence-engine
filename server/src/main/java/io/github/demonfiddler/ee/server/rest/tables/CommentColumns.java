...
public class CommentColumns {
    ...
    private static final Column<Comment> TARGET = new Column<>("target", "Target", ColumnType.STRING, FULL,
        (rec, raw) -> RenderUtils.instance.renderEntityLabel(rec.getTarget()));
    private static final Column<Comment> PARENT = new Column<>("parent", "Parent", ColumnType.STRING, FULL,
        (rec, raw) -> rec.getParent() != null ? rec.getParent().getText() : "");
    private static final Column<Comment> TEXT = new Column<>("text", "Text", ColumnType.STRING, FULL, null);

    public static final List<Column<Comment>> OWN_COLUMNS = List.of(TARGET, PARENT, TEXT);
    public static final List<Column<Comment>> OWN_DEFAULT_COLUMNS = List.of(TEXT);
