 ...
 * fetching fields for the LinkAudit GraphQL type, as defined in the provided GraphQL schema. Please read the
 ...
 */
public interface DataFetchersDelegateLinkAudit {
	 ...
	 */
	Map<LinkAudit, List<LinkAuditEntry>> links(BatchLoaderEnvironment batchLoaderEnvironment,
	 ...
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	Map<LinkAudit, List<LinkGroupAuditEntry>> groups(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<LinkAudit> keys);
