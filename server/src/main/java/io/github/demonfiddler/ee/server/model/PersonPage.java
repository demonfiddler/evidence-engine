...
public class PersonPage implements IBaseEntityPage<Person> {
	...
	public static class Builder {
		 ...
		 * The requested pageful of records.
		 */
		public Builder withContent(List<Person> contentParam) {
		...
		public PersonPage build() {
			PersonPage _object = new PersonPage();
