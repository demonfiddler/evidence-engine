...
public class GroupController {
	...
	protected DataFetchersDelegateGroup dataFetchersDelegateGroup;

	protected GraphqlServerUtils graphqlServerUtils;

	public GroupController(BatchLoaderRegistry registry, DataFetchersDelegateGroup dataFetchersDelegateGroup,
		GraphqlServerUtils graphqlServerUtils) {

		this.dataFetchersDelegateGroup = dataFetchersDelegateGroup;
		...
		registry.forTypePair(Long.class, Group.class).registerMappedBatchLoader((keysSet, env) -> {
			...
			return Mono.fromCallable(() -> {
				...
				List<Group> values = this.dataFetchersDelegateGroup.batchLoader(keys, env);
	...
	/**
	 * Loads the data for Group.entityKind. It returns an Object: the data fetcher implementation may return any type
	...
	public Object entityKind(DataFetchingEnvironment dataFetchingEnvironment, Group origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateGroup.entityKind(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}

	/**
	 * Loads the data for Group.status. It returns an Object: the data fetcher implementation may return any type that is
	...
	public Object status(DataFetchingEnvironment dataFetchingEnvironment, Group origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateGroup.status(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}

	/**
	 * Loads the data for Group.createdByUser. It is generated as the
	...
	public Map<Group, User> createdByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Group> keys) {

		return this.dataFetchersDelegateGroup.createdByUser(batchLoaderEnvironment, graphQLContext, keys);
	}

	/**
	 * Loads the data for Group.updatedByUser. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environment for this batch loader. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	...
	public Map<Group, User> updatedByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Group> keys) {

		return this.dataFetchersDelegateGroup.updatedByUser(batchLoaderEnvironment, graphQLContext, keys);
	}

	/**
	 * Loads the data for Group.log. It returns an Object: the data fetcher implementation may return any type that is
	 * accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	...
	public Object log(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, LogPage> dataLoader,
		Group origin, @Argument("filter") LogQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateGroup.log(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}

	/**
	 * This method loads the data for Group.comments. It returns an Object: the data fetcher implementation may return
	...
	public Object comments(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, CommentPage> dataLoader,
		Group origin, @Argument("filter") CommentQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateGroup.comments(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}

	/**
	 * Loads the data for Group.authorities. It returns an Object: the data fetcher implementation may return any type
	 * that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	...
	public Object authorities(DataFetchingEnvironment dataFetchingEnvironment, Group origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateGroup.authorities(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}

   	/**
	 * Loads the data for ${dataFetcher.graphQLType}.members. It is generated as the 
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * 
	 ...
	 * 		Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	@BatchMapping(field = "members")
	public Map<Group, List<User>> members(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext, List<Group> keys) {
		return this.dataFetchersDelegateGroup.members(batchLoaderEnvironment, graphQLContext, keys);
	}
