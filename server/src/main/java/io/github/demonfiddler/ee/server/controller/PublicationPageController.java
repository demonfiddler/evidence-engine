...
public class PublicationPageController {
	...
	protected final DataFetchersDelegatePublicationPage dataFetchersDelegatePublicationPage;
	...
	/**
	 * Loads the data for PublicationPage.content. It is generated as the
