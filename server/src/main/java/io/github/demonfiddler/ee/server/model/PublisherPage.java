...
public class PublisherPage implements IBaseEntityPage<Publisher> {
	...
	public String toString() {
		return "PublisherPage {" //$NON-NLS-1$
	...
	public static class Builder {
		...
		private Long dummy;
		private List<Publisher> content;
		 ...
		 * The requested pageful of records.
		 */
		public Builder withContent(List<Publisher> contentParam) {
		...
		public PublisherPage build() {
			PublisherPage _object = new PublisherPage();
