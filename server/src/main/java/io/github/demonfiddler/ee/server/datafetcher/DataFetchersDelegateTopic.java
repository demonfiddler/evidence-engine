 ...
 * fields for the Topic GraphQL type, as defined in the provided GraphQL schema. Please read the
 ...
 */
public interface DataFetchersDelegateTopic extends DataFetchersDelegateILinkableEntity<Topic> {

	/**
	 * Loads the data for Topic.parent. It is generated as the <code>generateBatchMappingDataFetchers</code> plugin
	 ...
	 */
	Map<Topic, Topic> parent(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Topic> keys);

	/**
	 * Loads the data for Topic.children. It is generated as the <code>generateBatchMappingDataFetchers</code> plugin
	 * parameter is true. <br/>
	 * @param batchLoaderEnvironment The environment for this batch loader. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	 ...
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	Map<Topic, List<Topic>> children(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Topic> keys);
