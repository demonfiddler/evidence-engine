 ...
 * fetching fields for the EntityLink GraphQL type, as defined in the provided GraphQL schema. Please read the
 ...
 */
public interface DataFetchersDelegateEntityLink extends DataFetchersDelegateITrackedEntity<EntityLink> {

	/**
	 * Loads the data for EntityLink.fromEntity. It is generated as the <code>generateBatchMappingDataFetchers</code>
	 ...
	 */
	Map<EntityLink, ILinkableEntity> fromEntity(BatchLoaderEnvironment batchLoaderEnvironment,
	 ...
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	Map<EntityLink, ILinkableEntity> toEntity(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<EntityLink> keys);
