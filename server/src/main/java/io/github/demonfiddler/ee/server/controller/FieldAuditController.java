...
public class FieldAuditController {
	...
	public Map<FieldAudit, List<FieldAuditEntry>> fields(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateFieldAudit.fields(batchLoaderEnvironment, graphQLContext, keys);
	}

	/**
	 * This methods loads the data for FieldAudit.groups. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environement for this batch loaded. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	...
	public Map<FieldAudit, List<FieldGroupAuditEntry>> groups(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateFieldAudit.groups(batchLoaderEnvironment, graphQLContext, keys);
	}
