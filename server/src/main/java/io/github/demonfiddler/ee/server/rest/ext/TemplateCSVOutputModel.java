...
/**
 * Stores CSV markup to be printed; used with {@link CSVOutputFormat}.
 */
public class TemplateCSVOutputModel extends CommonTemplateMarkupOutputModel<TemplateCSVOutputModel> {
     ...
     */
    protected TemplateCSVOutputModel(String plainTextContent, String markupContent) {
        super(plainTextContent, markupContent);
    }

    @Override
    public CSVOutputFormat getOutputFormat() {
