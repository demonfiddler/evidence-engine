...
public enum DeclarationKind {
	...
	static public DeclarationKind fromGraphQlValue(String graphQlValue) {
		...
		for (DeclarationKind e : DeclarationKind.values()) {
			if (e.graphQlValue().equals(graphQlValue)) {
				return e;
			}
		}
		throw new IllegalArgumentException("No DeclarationKind exists with '" + graphQlValue + "' as a GraphQL value"); //$NON-NLS-1$ //$NON-NLS-2$
	}

	DeclarationKind(String graphQlValue) {
