 ...
 */
public interface DataFetchersDelegatePublisher extends DataFetchersDelegateITrackedEntity<Publisher> {

	/**
	 * Description for the country field: <br/>
	 * The publisher country. <br/>
	 * Loads the data for Publisher.country. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 ...
	 * params:[]}}, implements IBaseEntity,ITrackedEntity, comments ""}. It depends on your data model, but it typically
