 ...
 * fetching fields for the PersonPage GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegatePersonPage {
	 ...
	 */
	Map<PersonPage, List<Person>> content(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
	 ...
	 */
	default List<PersonPage> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<PersonPage> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegatePersonPage implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<PersonPage> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
