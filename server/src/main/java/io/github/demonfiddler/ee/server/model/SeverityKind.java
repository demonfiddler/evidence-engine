...
public enum SeverityKind {
	...
	// The graphQlValue is needed on server side, to map the enum value to the value defined in the GraphQL schema. They are
	// different when the value in the GraphQL schema is a Java reserved keyword.
	 ...
	 */
	static public SeverityKind fromGraphQlValue(String graphQlValue) {
		if (graphQlValue == null) {
			return null;
		}
		for (SeverityKind e : SeverityKind.values()) {
			if (e.graphQlValue().equals(graphQlValue)) {
				return e;
			}
		}
		throw new IllegalArgumentException("No SeverityKind exists with '" + graphQlValue + "' as a GraphQL value");
	}

	SeverityKind(String graphQlValue) {
