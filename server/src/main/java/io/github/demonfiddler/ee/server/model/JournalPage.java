 ...
 */
@Entity
@GraphQLObjectType("JournalPage")
public class JournalPage implements IBaseEntityPage<Journal> {
	 ...
	 */
	@Transient
	@GraphQLNonScalar(fieldName = "content", graphQLTypeSimpleName = "Journal", javaClass = Journal.class,
		listDepth = 1)
	 ...
	 * The requested pageful of records.
	 */
	public void setContent(List<Journal> content) {
	 ...
	 * The requested pageful of records.
	 */
	public List<Journal> getContent() {
		return this.content;
	}
	...
	public static class Builder {
		 ...
		 * The requested pageful of records.
		 */
		public Builder withContent(List<Journal> contentParam) {
		...
		public JournalPage build() {
			JournalPage _object = new JournalPage();
