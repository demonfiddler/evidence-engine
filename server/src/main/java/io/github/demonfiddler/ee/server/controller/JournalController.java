...
public class JournalController {
	...
	public JournalController(BatchLoaderRegistry registry) {
		...
		registry.forTypePair(Long.class, Journal.class).registerMappedBatchLoader((keysSet, env) -> {
			...
			return Mono.fromCallable(() -> {
				Map<Long, Journal> map = new HashMap<>();
				// Values are returned in the same order as the keys list
				List<Journal> values = this.dataFetchersDelegateJournal.batchLoader(keys, env);
	...
	/**
	 * Loads the data for Journal.entityKind. It returns an Object: the data fetcher
	...
	public Object entityKind(DataFetchingEnvironment dataFetchingEnvironment, Journal origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateJournal.entityKind(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}

	/**
	 * Loads the data for Journal.status. It returns an Object: the data fetcher
	 * implementation may return any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	...
	public Object status(DataFetchingEnvironment dataFetchingEnvironment, Journal origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateJournal.status(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}

	/**
	 * Loads the data for Journal.createdByUser. It is generated as the
	...
	public Map<Journal, User> createdByUser(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateJournal.createdByUser(batchLoaderEnvironment, graphQLContext, keys);
	}

	/**
	 * Loads the data for Journal.updatedByUser. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environment for this batch loader. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	...
	public Map<Journal, User> updatedByUser(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateJournal.updatedByUser(batchLoaderEnvironment, graphQLContext, keys);
	}

	/**
	 * Loads the data for Journal.log. It returns an Object: the data fetcher
	 * implementation may return any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	...
	public Object log(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, LogPage> dataLoader,
		Journal origin, @Argument("filter") LogQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateJournal.log(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}

	/**
	 * This method loads the data for Journal.comments. It returns an Object: the data fetcher implementation may return
	...
	public Object comments(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, CommentPage> dataLoader,
		Journal origin, @Argument("filter") CommentQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateJournal.comments(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}

	/**
	 * Loads the data for Journal.publisher. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environment for this batch loader. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	...
	public Map<Journal, Publisher> publisher(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateJournal.publisher(batchLoaderEnvironment, graphQLContext, keys);
	}
