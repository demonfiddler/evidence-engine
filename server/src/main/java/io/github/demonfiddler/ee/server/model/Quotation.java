...
public class Quotation implements IBaseEntity, ITrackedEntity, ITopicalEntity {
	...
	/**
	 * The quotation author (quotee).
	 */
	@GraphQLScalar(fieldName = "author", graphQLTypeSimpleName = "String", javaClass = String.class, listDepth = 0)
	String author;
	...
	public static class Builder {
		 ...
		 * The quotation author (quotee).
		 */
		public Builder withAuthor(String authorParam) {
