 ...
 * fetching fields for the TopicRefPage GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateTopicRefPage {
	 ...
	 */
	Map<TopicRefPage, List<TopicRef>> content(BatchLoaderEnvironment batchLoaderEnvironment,
	 ...
	 */
	default List<TopicRefPage> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<TopicRefPage> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateTopicRefPage implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<TopicRefPage> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
