 ...
 * fetching fields for the Publication GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegatePublication {

	/**
	 * Description for the status field: <br/>
	 * The entity status. <br/>
	 * This method loads the data for Publication.status. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 ...
	 * the status attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Publication,
	 ...
	 */
	Object status(DataFetchingEnvironment dataFetchingEnvironment, Publication origin, FormatKind format);
	 ...
	 */
	Map<Publication, User> createdByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
	 ...
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	Map<Publication, User> updatedByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Publication> keys);

	/**
	 * Description for the log field: <br/>
	 * Log of transactions involving the record. <br/>
	 * This method loads the data for Publication.log. It may return whatever is accepted by the Spring Controller, that
	 * is:
	 * <ul>
	 ...
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the log attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Publication,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:status, type:String,
	 * params:[format:FormatKind]},Field{name:created, type:DateTime, params:[]},Field{name:createdByUser, type:User,
	 * params:[]},Field{name:updated, type:DateTime, params:[]},Field{name:updatedByUser, type:User,
	 * params:[]},Field{name:log, type:LogPage!,
	 ...
	 * The topic(s) associated with the publication. <br/>
	 * This method loads the data for Publication.topicRefs. It may return whatever is accepted by the Spring
	 * Controller, that is:
	 * <ul>
	 ...
	 * <A HREF= "https://github.com/graphql-java/java-dataloader">https://github.com/graphql-java/java-dataloader</A>
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the topicRefs attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Publication,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:status, type:String,
	 * params:[format:FormatKind]},Field{name:created, type:DateTime, params:[]},Field{name:createdByUser, type:User,
	 * params:[]},Field{name:updated, type:DateTime, params:[]},Field{name:updatedByUser, type:User,
	 * params:[]},Field{name:log, type:LogPage!,
	...
	/**
	 * This methods loads the data for ${dataFetcher.graphQLType}.journal. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environement for this batch loaded. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	 ...
	 * This method loads the data for Publication.kind. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 * <li>A resolved value of any type (typically, a String)</li>
	 * <li>Mono and Flux for asynchronous value(s). Supported for controller methods and for any DataFetcher as
	 ...
	 */
	default List<Publication> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<Publication> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegatePublication implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<Publication> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
