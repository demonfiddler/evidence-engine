...
public class ClaimPage implements IBaseEntityPage<Claim> {
	...
	public static class Builder {
		 ...
		 * The requested pageful of records.
		 */
		public Builder withContent(List<Claim> contentParam) {
		...
		public ClaimPage build() {
			ClaimPage _object = new ClaimPage();
