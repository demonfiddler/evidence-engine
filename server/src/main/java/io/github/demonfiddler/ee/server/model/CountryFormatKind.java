...
public enum CountryFormatKind {
	...
	private CountryFormatKind(String graphQlValue) {
	...
	public static CountryFormatKind fromGraphQlValue(String graphQlValue) {
		...
		for (CountryFormatKind e : CountryFormatKind.values()) {
			if (e.graphQlValue().equals(graphQlValue)) {
				return e;
			}
		}
		throw new IllegalArgumentException("No CountryFormatKind exists with '" + graphQlValue + "' as a GraphQL value");
	}
