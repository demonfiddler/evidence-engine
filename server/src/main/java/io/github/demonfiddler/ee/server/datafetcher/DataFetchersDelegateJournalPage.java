 ...
 * fetching fields for the JournalPage GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateJournalPage {
	 ...
	 */
	Flux<Journal> content(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
	 ...
	 */
	default List<JournalPage> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<JournalPage> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateJournalPage implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<JournalPage> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
