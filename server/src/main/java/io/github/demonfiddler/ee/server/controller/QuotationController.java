...
public class QuotationController {
	...
	/**
	 * Loads the data for Quotation.entityKind. It returns an Object: the data fetcher implementation may return any
	...
	public Object entityKind(DataFetchingEnvironment dataFetchingEnvironment, Quotation origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateQuotation.entityKind(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}

	/**
	 * Loads the data for Quotation.status. It returns an Object: the data fetcher implementation may return any type
	...
	/**
	 * Loads the data for Quotation.createdByUser. It is generated as the
	...
	/**
	 * Loads the data for Quotation.updatedByUser. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environment for this batch loader. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	...
	/**
	 * Loads the data for Quotation.log. It returns an Object: the data fetcher implementation may return any type that
	...
	/**
	 * This method loads the data for Quotation.comments. It returns an Object: the data fetcher implementation may return
	...
	public Object comments(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, CommentPage> dataLoader,
		Quotation origin, @Argument("filter") CommentQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateQuotation.comments(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}

	/**
	 * Loads the data for Quotation.fromEntityLinks. It returns an Object: the data fetcher implementation may return
	 * any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param dataLoader The {@link DataLoader} allows to load several data in one query. It allows to solve the (n+1)
	...
	public Object fromEntityLinks(DataFetchingEnvironment dataFetchingEnvironment,
		DataLoader<Long, EntityLinkPage> dataLoader, Quotation origin,
		@Argument("filter") LinkableEntityQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateQuotation.fromEntityLinks(dataFetchingEnvironment, dataLoader, origin, filter,
			pageSort);
	}

	/**
	 * Loads the data for Quotation.toEntityLinks. It returns an Object: the data fetcher implementation may return any
	 * type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param dataLoader The {@link DataLoader} allows to load several data in one query. It allows to solve the (n+1)
	...
	public Object toEntityLinks(DataFetchingEnvironment dataFetchingEnvironment,
		...
		return this.dataFetchersDelegateQuotation.toEntityLinks(dataFetchingEnvironment, dataLoader, origin, filter,
			pageSort);
	}
