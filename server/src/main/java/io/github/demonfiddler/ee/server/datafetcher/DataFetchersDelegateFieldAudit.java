 ...
 * fetching fields for the FieldAudit GraphQL type, as defined in the provided GraphQL schema. Please read the
 ...
 */
public interface DataFetchersDelegateFieldAudit {

	/**
	 * This methods loads the data for ${dataFetcher.graphQLType}.fields. It is generated as the
	 ...
	 * @param keys The objects for which the value for the fields field must be retrieved.
	 ...
	 */
	Map<FieldAudit, List<FieldAuditEntry>> fields(BatchLoaderEnvironment batchLoaderEnvironment,
	 ...
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	Map<FieldAudit, List<FieldGroupAuditEntry>> groups(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<FieldAudit> keys);
