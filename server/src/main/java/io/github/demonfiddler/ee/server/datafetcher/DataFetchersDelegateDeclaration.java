 ...
 */
public interface DataFetchersDelegateDeclaration extends DataFetchersDelegateILinkableEntity<Declaration> {

	/**
	 * Description for the kind field: <br/>
	 * The kind of declaration. <br/>
	 * Loads the data for Declaration.kind. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 ...
	 * Loads the data for Declaration.country. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 * <li>A resolved value of any type (typically, a String)</li>
	 * <li>Mono and Flux for asynchronous value(s). Supported for controller methods and for any DataFetcher as
