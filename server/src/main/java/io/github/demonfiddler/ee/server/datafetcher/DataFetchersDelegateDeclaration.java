 ...
 * fetching fields for the Declaration GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateDeclaration {

	/**
	 * Description for the status field: <br/>
	 * The entity status. <br/>
	 * This method loads the data for Declaration.status. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 ...
	 * the status attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Declaration,
	 ...
	 */
	Object status(DataFetchingEnvironment dataFetchingEnvironment, Declaration origin, FormatKind format);
	 ...
	 */
	Map<Declaration, User> createdByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
	 ...
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	Map<Declaration, User> updatedByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Declaration> keys);

	/**
	 * Description for the log field: <br/>
	 * Log of transactions involving the record. <br/>
	 * This method loads the data for Declaration.log. It may return whatever is accepted by the Spring Controller, that
	 * is:
	 * <ul>
	 ...
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the log attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Declaration,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:status, type:String,
	 * params:[format:FormatKind]},Field{name:created, type:DateTime, params:[]},Field{name:createdByUser, type:User,
	 * params:[]},Field{name:updated, type:DateTime, params:[]},Field{name:updatedByUser, type:User,
	 * params:[]},Field{name:log, type:LogPage!,
	 ...
	 * The topic(s) associated with the declaration. <br/>
	 * This method loads the data for Declaration.topicRefs. It may return whatever is accepted by the Spring
	 * Controller, that is:
	 * <ul>
	 ...
	 * <A HREF= "https://github.com/graphql-java/java-dataloader">https://github.com/graphql-java/java-dataloader</A>
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the topicRefs attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Declaration,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:status, type:String,
	 * params:[format:FormatKind]},Field{name:created, type:DateTime, params:[]},Field{name:createdByUser, type:User,
	 * params:[]},Field{name:updated, type:DateTime, params:[]},Field{name:updatedByUser, type:User,
	 * params:[]},Field{name:log, type:LogPage!,
	 ...
	 * The kind of declaration. <br/>
	 * This method loads the data for Declaration.kind. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 * <li>A resolved value of any type (typically, a String)</li>
	 * <li>Mono and Flux for asynchronous value(s). Supported for controller methods and for any DataFetcher as
	 ...
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the kind attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Declaration,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:status, type:String,
	 * params:[format:FormatKind]},Field{name:created, type:DateTime, params:[]},Field{name:createdByUser, type:User,
	 * params:[]},Field{name:updated, type:DateTime, params:[]},Field{name:updatedByUser, type:User,
	 * params:[]},Field{name:log, type:LogPage!,
	 ...
	 * will take care of the {@link NoSuchElementException} exception.
	 */
	Object kind(DataFetchingEnvironment dataFetchingEnvironment, Declaration origin, FormatKind format);

	/**
	 * Description for the country field: <br/>
	 * The country to which the declaration relates. <br/>
	 * This method loads the data for Declaration.country. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 * <li>A resolved value of any type (typically, a String)</li>
	 * <li>Mono and Flux for asynchronous value(s). Supported for controller methods and for any DataFetcher as
	 ...
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the country attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Declaration,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:status, type:String,
	 * params:[format:FormatKind]},Field{name:created, type:DateTime, params:[]},Field{name:createdByUser, type:User,
	 * params:[]},Field{name:updated, type:DateTime, params:[]},Field{name:updatedByUser, type:User,
	 * params:[]},Field{name:log, type:LogPage!,
	 ...
	 * will take care of the {@link NoSuchElementException} exception.
	 */
	Object country(DataFetchingEnvironment dataFetchingEnvironment, Declaration origin, CountryFormatKind format);
	 ...
	 */
	default List<Declaration> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<Declaration> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateDeclaration implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<Declaration> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
