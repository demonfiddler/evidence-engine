 ...
 * fetching fields for the ITopicalEntity GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateITopicalEntity {

	/**
	 * Description for the topicRefs field: <br/>
	 * The topic(s) associated with the entity. <br/>
	 * This method loads the data for ITopicalEntity.topicRefs. It may return whatever is accepted by the Spring
	 * Controller, that is:
	 * <ul>
	 ...
	 * the topicRefs attribute of the <I>origin</I>, which is an instance of {InterfaceType {name:ITopicalEntity,
	 * fields:{Field{name:topicRefs, type:TopicRefPage!, params:[filter:TopicRefQueryFilter,pageSort:PageableInput]}},
