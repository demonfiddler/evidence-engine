...
public class UserController {
	...
	protected final DataFetchersDelegateUser dataFetchersDelegateUser;

	protected GraphqlServerUtils graphqlServerUtils;

	public UserController(BatchLoaderRegistry registry, DataFetchersDelegateUser dataFetchersDelegateUser,
	...
	/**
	 * This method loads the data for User.comments. It returns an Object: the data fetcher implementation may return
	...
	public Object comments(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, CommentPage> dataLoader,
		User origin, @Argument("filter") CommentQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateUser.comments(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}
	...
	public Object country(DataFetchingEnvironment dataFetchingEnvironment, User origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateUser.country(dataFetchingEnvironment, origin,
