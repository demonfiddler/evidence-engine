...
public class ClaimController {
	...
	protected DataFetchersDelegateClaim dataFetchersDelegateClaim;
	protected GraphqlServerUtils graphqlServerUtils;

	public ClaimController(BatchLoaderRegistry registry, DataFetchersDelegateClaim dataFetchersDelegateClaim,
		...
		registry.forTypePair(Long.class, Claim.class).registerMappedBatchLoader((keysSet, env) -> {
			List<Long> keys = new ArrayList<>(keysSet.size());
			keys.addAll(keysSet);
			return Mono.fromCallable(() -> {
				Map<Long, Claim> map = new HashMap<>();
				// Values are returned in the same order as the keys list
				List<Claim> values = this.dataFetchersDelegateClaim.batchLoader(keys, env);
	...
	public Object entityKind(DataFetchingEnvironment dataFetchingEnvironment, Claim origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateClaim.entityKind(dataFetchingEnvironment, origin,
	...
	public Object status(DataFetchingEnvironment dataFetchingEnvironment, Claim origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateClaim.status(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}
	...
	public Map<Claim, User> createdByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		...
		return this.dataFetchersDelegateClaim.createdByUser(batchLoaderEnvironment, graphQLContext, keys);
	}
	...
	public Map<Claim, User> updatedByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Claim> keys) {

		return this.dataFetchersDelegateClaim.updatedByUser(batchLoaderEnvironment, graphQLContext, keys);
	}
	...
	public Object log(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, LogPage> dataLoader,
		Claim origin, @Argument("filter") LogQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateClaim.log(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}
	...
	public Object fromEntityLinks(DataFetchingEnvironment dataFetchingEnvironment,
		DataLoader<Long, EntityLinkPage> dataLoader, Claim origin, @Argument("filter") LinkableEntityQueryFilter filter,
		@Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateClaim.fromEntityLinks(dataFetchingEnvironment, dataLoader, origin, filter,
			pageSort);
	}
	...
	public Object toEntityLinks(DataFetchingEnvironment dataFetchingEnvironment,
		...
		return this.dataFetchersDelegateClaim.toEntityLinks(dataFetchingEnvironment, dataLoader, origin, filter,
			pageSort);
	}
