...
public class TopicRefPage implements IBaseEntityPage<TopicRef> {
	...
	public static class Builder {
		 ...
		 * The requested pageful of records.
		 */
		public Builder withContent(List<TopicRef> contentParam) {
		...
		public TopicRefPage build() {
			TopicRefPage _object = new TopicRefPage();
