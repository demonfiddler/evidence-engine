 ...
 * fetching fields for the LinkAuditEntry GraphQL type, as defined in the provided GraphQL schema. Please read the
 ...
 */
public interface DataFetchersDelegateLinkAuditEntry {

	/**
	 * Description for the linkedEntityKind field: <br/>
	 * The linked entity kind. <br/>
	 * This method loads the data for LinkAuditEntry.linkedEntityKind. It may return whatever is accepted by the Spring
	 * Controller, that is:
	 * <ul>
	 ...
	 * the linkedEntityKind attribute of the <I>origin</I>, which is an instance of {ObjectType {name:LinkAuditEntry,
	 * fields:{Field{name:linkedEntityKind, type:String, params:[format:FormatKind]},Field{name:min, type:Int,
	 * params:[]},Field{name:actual, type:Int, params:[]},Field{name:pass, type:Boolean, params:[]}}, comments ""}. It
	 * depends on your data modle, but it typically contains the id to use in the query.
	 ...
	 */
	Object linkedEntityKind(DataFetchingEnvironment dataFetchingEnvironment, LinkAuditEntry origin, FormatKind format);
