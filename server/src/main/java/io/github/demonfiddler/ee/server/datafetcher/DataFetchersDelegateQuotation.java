 ...
 * fetching fields for the Quotation GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateQuotation {

	/**
	 * Description for the status field: <br/>
	 * The entity status. <br/>
	 * This method loads the data for Quotation.status. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 ...
	 * the status attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Quotation,
	 ...
	 * params:[filter:TopicRefQueryFilter,pageSort:PageableInput]},Field{name:author, type:String,
	 * params:[]},Field{name:text, type:String, params:[]},Field{name:date, type:Date, params:[]},Field{name:source,
	 * type:String, params:[]},Field{name:url, type:URL, params:[]}}, implements
	 ...
	 */
	Object status(DataFetchingEnvironment dataFetchingEnvironment, Quotation origin, FormatKind format);
	 ...
	 */
	Map<Quotation, User> createdByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Quotation> keys);
	 ...
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	Map<Quotation, User> updatedByUser(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Quotation> keys);

	/**
	 * Description for the log field: <br/>
	 * Log of transactions involving the record. <br/>
	 * This method loads the data for Quotation.log. It may return whatever is accepted by the Spring Controller, that
	 * is:
	 * <ul>
	 ...
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the log attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Quotation,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:status, type:String,
	 * params:[format:FormatKind]},Field{name:created, type:DateTime, params:[]},Field{name:createdByUser, type:User,
	 * params:[]},Field{name:updated, type:DateTime, params:[]},Field{name:updatedByUser, type:User,
	 * params:[]},Field{name:log, type:LogPage!,
	 ...
	 * will take care of the {@link NoSuchElementException} exception.
	 */
	Object log(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, LogPage> dataLoader, Quotation origin,
		LogQueryFilter filter, PageableInput pageSort);

	/**
	 * Description for the topicRefs field: <br/>
	 * The topic(s) associated with the quotation. <br/>
	 * This method loads the data for Quotation.topicRefs. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 ...
	 * <A HREF= "https://github.com/graphql-java/java-dataloader">https://github.com/graphql-java/java-dataloader</A>
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the topicRefs attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Quotation,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:status, type:String,
	 * params:[format:FormatKind]},Field{name:created, type:DateTime, params:[]},Field{name:createdByUser, type:User,
	 * params:[]},Field{name:updated, type:DateTime, params:[]},Field{name:updatedByUser, type:User,
	 * params:[]},Field{name:log, type:LogPage!,
	 ...
	 */
	default List<Quotation> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<Quotation> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateQuotation implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<Quotation> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
