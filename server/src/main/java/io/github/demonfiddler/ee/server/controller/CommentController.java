...
public class CommentController {
	...
	public CommentController(BatchLoaderRegistry registry) {
		...
		registry.forTypePair(Long.class, Comment.class).registerMappedBatchLoader((keysSet, env) -> {
			...
			return Mono.fromCallable(() -> {
				...
				List<Comment> values = this.dataFetchersDelegateComment.batchLoader(keys, env);
	...
	public Object entityKind(DataFetchingEnvironment dataFetchingEnvironment, Comment origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateComment.entityKind(dataFetchingEnvironment, origin,
	...
	public Object status(DataFetchingEnvironment dataFetchingEnvironment, Comment origin,
		@Argument("format") String format) {

		return this.dataFetchersDelegateComment.status(dataFetchingEnvironment, origin,
			(FormatKind)GraphqlUtils.graphqlUtils.stringToEnumValue(format, FormatKind.class));
	}
	...
	public Map<Comment, User> createdByUser(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<Comment> keys) {

		return this.dataFetchersDelegateComment.createdByUser(batchLoaderEnvironment, graphQLContext, keys);
	}
	...
	public Map<Comment, User> updatedByUser(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<Comment> keys) {

		return this.dataFetchersDelegateComment.updatedByUser(batchLoaderEnvironment, graphQLContext, keys);
	}
	...
	public Object log(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, LogPage> dataLoader,
		Comment origin, @Argument("filter") LogQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateComment.log(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}

	/**
	 * This method loads the data for ${dataFetcher.graphQLType}.comments. It returns an Object: the data fetcher
	 * implementation may return any type that is accepted by a spring-graphql controller<BR/>
	 * @param dataFetchingEnvironment The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full
	 * GraphQL context for this DataFetcher
	 * @param dataLoader The {@link DataLoader} allows to load several data in one query. It allows to solve the (n+1)
	...
	public Object comments(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, CommentPage> dataLoader,
		Comment origin, @Argument("filter") CommentQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateComment.comments(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}

	/**
	 * This methods loads the data for Comment.target. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environement for this batch loaded. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	 * @param keys The objects for which the value for the target field must be retrieved.
	 * @return This method returns <code>${dataFetcher.batchMappingReturnType.value}</code>, as defined by the
	 * <code>batchMappingDataFetcherReturnType</code> plugin parameter. <br/>
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	@BatchMapping(field = "target")
	public Map<Comment, ITrackedEntity> target(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<Comment> keys) {

		return this.dataFetchersDelegateComment.target(batchLoaderEnvironment, graphQLContext, keys);
	}

	/**
	 * This methods loads the data for Comment.parent. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 * @param batchLoaderEnvironment The environement for this batch loaded. You can extract the GraphQLContext from
	 * this parameter.
	 * @param graphQLContext
	...
	public Map<Comment, Comment> parent(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		...
		return this.dataFetchersDelegateComment.parent(batchLoaderEnvironment, graphQLContext, keys);
	}

	@BatchMapping(field = "text")
	public Map<Comment, String> text(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Comment> keys) {

		return this.dataFetchersDelegateComment.text(batchLoaderEnvironment, graphQLContext, keys);
	}
