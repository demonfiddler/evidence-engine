 ...
 */
@Entity
@GraphQLObjectType("LogPage")
public class LogPage implements IBaseEntityPage<Log> {
	...
	public static class Builder {
		 ...
		 * The requested pageful of records.
		 */
		public Builder withContent(List<Log> contentParam) {
