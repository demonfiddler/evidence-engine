 ...
 * fields for the IBaseEntity GraphQL type, as defined in the provided GraphQL schema. Please read the
 ...
 */
public interface DataFetchersDelegateIBaseEntity<T extends IBaseEntity> {

	/**
	 * Loads a list of T, based on the list of id to be fetched. This method is used by
	 ...
	 * @return A list of {@code T}s
	 */
	default List<T> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
	 ...
	 * @return A list of {@code T}s
	 */
	default List<T> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
