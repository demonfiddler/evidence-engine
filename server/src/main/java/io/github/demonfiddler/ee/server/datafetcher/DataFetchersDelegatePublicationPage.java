 ...
 * fetching fields for the PublicationPage GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegatePublicationPage {
	 ...
	 */
	Map<PublicationPage, List<Publication>> content(BatchLoaderEnvironment batchLoaderEnvironment,
	 ...
	 */
	default List<PublicationPage> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<PublicationPage> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegatePublicationPage implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<PublicationPage> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
