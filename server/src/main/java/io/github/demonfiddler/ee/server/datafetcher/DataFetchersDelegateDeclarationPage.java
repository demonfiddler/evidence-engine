 ...
 * fetching fields for the DeclarationPage GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateDeclarationPage {
	 ...
	 */
	Map<DeclarationPage, List<Declaration>> content(BatchLoaderEnvironment batchLoaderEnvironment,
	 ...
	 */
	default List<DeclarationPage> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<DeclarationPage> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateDeclarationPage implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<DeclarationPage> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
