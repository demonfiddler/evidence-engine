 ...
 * fetching fields for the Log GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateLog {
	 ...
	 * The kind of transaction. <br/>
	 * This method loads the data for Log.transactionKind. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 ...
	 * the transactionKind attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Log,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:timestamp, type:DateTime, params:[]},Field{name:userId,
	 * type:Long!, params:[]},Field{name:transactionKind, type:String,
	 * params:[format:FormatKind]},Field{name:entityKind, type:String, params:[format:FormatKind]},Field{name:entityId,
	 * type:Long, params:[]},Field{name:linkedEntityKind, type:String,
	 * params:[format:FormatKind]},Field{name:linkedEntityId, type:Long, params:[]}}, implements IBaseEntity,
	 ...
	 */
	Object transactionKind(DataFetchingEnvironment dataFetchingEnvironment, Log origin, FormatKind format);

	/**
	 * Description for the entityKind field: <br/>
	 * The kind of entity affected. <br/>
	 * This method loads the data for Log.entityKind. It may return whatever is accepted by the Spring Controller, that
	 * is:
	 * <ul>
	 * <li>A resolved value of any type (typically, a String)</li>
	 * <li>Mono and Flux for asynchronous value(s). Supported for controller methods and for any DataFetcher as
	 ...
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the entityKind attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Log,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:timestamp, type:DateTime, params:[]},Field{name:userId,
	 * type:Long!, params:[]},Field{name:transactionKind, type:String,
	 * params:[format:FormatKind]},Field{name:entityKind, type:String, params:[format:FormatKind]},Field{name:entityId,
	 * type:Long, params:[]},Field{name:linkedEntityKind, type:String,
	 ...
	 * will take care of the {@link NoSuchElementException} exception.
	 */
	Object entityKind(DataFetchingEnvironment dataFetchingEnvironment, Log origin, FormatKind format);

	/**
	 * Description for the linkedEntityKind field: <br/>
	 * The kind of entity linked/unlinked (where applicable). <br/>
	 * This method loads the data for Log.linkedEntityKind. It may return whatever is accepted by the Spring Controller,
	 * that is:
	 * <ul>
	 * <li>A resolved value of any type (typically, a String)</li>
	 * <li>Mono and Flux for asynchronous value(s). Supported for controller methods and for any DataFetcher as
	 ...
	 * GraphQL context for this DataFetcher
	 * @param origin The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch
	 * the linkedEntityKind attribute of the <I>origin</I>, which is an instance of {ObjectType {name:Log,
	 * fields:{Field{name:id, type:ID!, params:[]},Field{name:timestamp, type:DateTime, params:[]},Field{name:userId,
	 * type:Long!, params:[]},Field{name:transactionKind, type:String,
	 * params:[format:FormatKind]},Field{name:entityKind, type:String, params:[format:FormatKind]},Field{name:entityId,
	 * type:Long, params:[]},Field{name:linkedEntityKind, type:String,
	 ...
	 * will take care of the {@link NoSuchElementException} exception.
	 */
	Object linkedEntityKind(DataFetchingEnvironment dataFetchingEnvironment, Log origin, FormatKind format);
	 ...
	 */
	default List<Log> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<Log> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateLog implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<Log> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
