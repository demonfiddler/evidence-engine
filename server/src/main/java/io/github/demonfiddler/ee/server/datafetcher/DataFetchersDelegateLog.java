 ...
 * fields for the Log GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateLog {
	...
	/**
	 * Loads the data for Log.user. It is generated as the <code>generateBatchMappingDataFetchers</code> plugin
	 ...
	 * Loads the data for Log.transactionKind. It may return whatever is accepted by the Spring Controller, that is:
	 * <ul>
	 ...
	 * Loads the data for Log.entityKind. It may return whatever is accepted by the Spring Controller, that is:
	 * <ul>
	 * <li>A resolved value of any type (typically, a String)</li>
	 * <li>Mono and Flux for asynchronous value(s). Supported for controller methods and for any DataFetcher as
	 * described in Reactive DataFetcher. This would typically be a Mono&lt;String&gt; or a Flux&lt;String&gt;</li>
	 ...
	 * Loads the data for Log.linkedEntityKind. It may return whatever is accepted by the Spring Controller, that is:
	 * <ul>
	 * <li>A resolved value of any type (typically, a String)</li>
	 * <li>Mono and Flux for asynchronous value(s). Supported for controller methods and for any DataFetcher as
	 * described in Reactive DataFetcher. This would typically be a Mono&lt;String&gt; or a Flux&lt;String&gt;</li>
	...
	/**
	 * Loads a list of Log, based on the list of id to be fetched. This method is used by
	 * <A HREF="https://github.com/graphql-java/java-dataloader">graphql-java java-dataloader</A> to highly optimize the
