...
public class Publication implements IBaseEntity, ITrackedEntity, ITopicalEntity {
	 ...
	 */
	@GraphQLScalar(fieldName = "issnIsbn", graphQLTypeSimpleName = "String", javaClass = String.class, listDepth = 0)
	String issnIsbn;
	...
	public String toString() {
		return "Publication {" //$NON-NLS-1$
			...
			+ ", " //$NON-NLS-1$
			+ "issnIsbn: " + this.issnIsbn //$NON-NLS-1$
			+ ", " //$NON-NLS-1$
	...
	public static class Builder {
		 ...
		 * The International Standard Serial/Book Number.
		 */
		public Builder withIssnIsbn(String issnIsbnParam) {
			this.issnIsbn = issnIsbnParam;
			return this;
		}
		 ...
		 * The date the publication was accessed when compiling the database.
		 */
		public Builder withAccessed(java.time.LocalDate accessedParam) {
		...
		public Publication build() {
			...
			_object.setIssnIsbn(this.issnIsbn);
