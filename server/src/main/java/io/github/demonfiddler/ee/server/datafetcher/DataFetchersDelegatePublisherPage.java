...
public interface DataFetchersDelegatePublisherPage {
	 ...
	 */
	Flux<Publisher> content(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<io.github.demonfiddler.ee.server.model.PublisherPage> keys);
