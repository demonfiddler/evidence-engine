...
public interface DataFetchersDelegatePublisherPage {
	 ...
	 */
	Map<PublisherPage, List<Publisher>> content(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<io.github.demonfiddler.ee.server.model.PublisherPage> keys);
	 ...
	 */
	default List<PublisherPage> batchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		List<PublisherPage> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null) {
			throw new NullPointerException(
				"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegatePublisherPage implementation. And unorderedReturnBatchLoader must return a list."); //$NON-NLS-1$
		}
	 ...
	 * @return
	 */
	default List<PublisherPage> unorderedReturnBatchLoader(List<Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
