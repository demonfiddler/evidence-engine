 ...
 * fields for the Journal GraphQL type, as defined in the provided GraphQL schema. Please read the
...
public interface DataFetchersDelegateJournal extends DataFetchersDelegateITrackedEntity<Journal> {

	/**
	 * Loads the data for Journal.publisher. It is generated as the <code>generateBatchMappingDataFetchers</code> plugin
	 ...
	 */
	Map<Journal, Publisher> publisher(BatchLoaderEnvironment batchLoaderEnvironment, GraphQLContext graphQLContext,
		List<Journal> keys);
