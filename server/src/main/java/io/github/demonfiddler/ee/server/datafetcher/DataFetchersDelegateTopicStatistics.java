 ...
 * fetching fields for the TopicStatistics GraphQL type, as defined in the provided GraphQL schema. Please read the
 ...
 */
public interface DataFetchersDelegateTopicStatistics {

	/**
	 * This methods loads the data for TopicStatistics.topic. It is generated as the
	 ...
	 */
	Map<TopicStatistics, Topic> topic(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<TopicStatistics> keys);

	/**
	 * This methods loads the data for TopicStatistics.entityStatistics. It is generated as the
	 * <code>generateBatchMappingDataFetchers</code> plugin parameter is true. <br/>
	 ...
	 * Please look at the spring-graphql annotation for a documentation on how to return the proper values
	 */
	Map<TopicStatistics, List<EntityStatistics>> entityStatistics(BatchLoaderEnvironment batchLoaderEnvironment,
		GraphQLContext graphQLContext, List<TopicStatistics> keys);
