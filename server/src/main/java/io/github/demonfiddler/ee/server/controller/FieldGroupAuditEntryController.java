 ...
 */
@Controller
@SchemaMapping(typeName = "FieldGroupAuditEntry")
public class FieldGroupAuditEntryController {

	protected final DataFetchersDelegateFieldGroupAuditEntry dataFetchersDelegateFieldGroupAuditEntry;

	protected final GraphqlServerUtils graphqlServerUtils;

	public FieldGroupAuditEntryController(
		DataFetchersDelegateFieldGroupAuditEntry dataFetchersDelegateFieldGroupAuditEntry,
		GraphqlServerUtils graphqlServerUtils) {

		this.dataFetchersDelegateFieldGroupAuditEntry = dataFetchersDelegateFieldGroupAuditEntry;
	...
	public Map<FieldGroupAuditEntry, List<FieldAuditEntry>> fields(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateFieldGroupAuditEntry.fields(batchLoaderEnvironment, graphQLContext, keys);
	}
