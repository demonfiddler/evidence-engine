...
public class ITrackedEntityController {
	...
	/**
	 * This method loads the data for ITrackedEntity.comments. It returns an Object: the data fetcher implementation may return
	...
	public Object comments(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<Long, CommentPage> dataLoader,
		AbstractTrackedEntity origin, @Argument("filter") CommentQueryFilter filter, @Argument("pageSort") PageableInput pageSort) {

		return this.dataFetchersDelegateITrackedEntity.comments(dataFetchingEnvironment, dataLoader, origin, filter, pageSort);
	}
