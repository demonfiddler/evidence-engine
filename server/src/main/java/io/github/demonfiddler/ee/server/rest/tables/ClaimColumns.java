...
public class ClaimColumns {
    ...
    private static final Column<Claim> DATE = new Column<>("date", "Date", ColumnType.DATE, SINGLE, null);
    private static final Column<Claim> TEXT = new Column<>("text", "Text", ColumnType.STRING, FULL, null);
    private static final Column<Claim> NOTES = new Column<>("notes", "Notes", ColumnType.STRING, FULL, null);

    public static final List<Column<Claim>> OWN_COLUMNS = List.of(DATE, TEXT, NOTES);
    public static final List<Column<Claim>> OWN_DEFAULT_COLUMNS = List.of(TEXT, DATE);
