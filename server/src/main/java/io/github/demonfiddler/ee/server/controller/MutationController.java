...
public class MutationController {
	...
	/**
	 * Loads the data for Mutation.deleteEntityLink.
	...
	public Object deleteEntityLink(DataFetchingEnvironment dataFetchingEnvironment,
		...
		@Argument("hard") Boolean hard) {

		return this.dataFetchersDelegateMutation.deleteEntityLink(dataFetchingEnvironment, entityLinkId, hard);
	}
