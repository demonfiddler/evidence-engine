 ...
 */
@GraphQLEnumType("AggregationKind")
public enum AggregationKind {
	...
	@GraphQLDirective(name = "@label", parameterNames = { "label" }, parameterTypes = { "String!" },
		parameterValues = { "Own authorities" })
	OWN("OWN", "Own authorities"), //
	/** Return all authorities both granted directly to the user and indirectly via group memberships. */
	@GraphQLDirective(name = "@label", parameterNames = { "label" }, parameterTypes = { "String!" },
		parameterValues = { "All authorities" })
	ALL("ALL", "All authorities");
	...
	private AggregationKind(String graphQlValue, String label) {
	 ...
	 */
	public static AggregationKind fromGraphQlValue(String graphQlValue) {
		if (graphQlValue == null) {
			return null;
		}
		for (AggregationKind e : AggregationKind.values()) {
			if (e.graphQlValue().equals(graphQlValue)) {
				return e;
			}
		}
		throw new IllegalArgumentException("No AggregationKind exists with '" + graphQlValue + "' as a GraphQL value");
	}
