 ...
 */
@Controller
@SchemaMapping(typeName = "GroupPage")
public class GroupPageController {

	protected final DataFetchersDelegateGroupPage dataFetchersDelegateGroupPage;

	protected GraphqlServerUtils graphqlServerUtils;

	public GroupPageController(BatchLoaderRegistry registry,
		DataFetchersDelegateGroupPage dataFetchersDelegateGroupPage, GraphqlServerUtils graphqlServerUtils) {

		this.dataFetchersDelegateGroupPage = dataFetchersDelegateGroupPage;
		...
		registry.forTypePair(Long.class, GroupPage.class).registerMappedBatchLoader((keysSet, env) -> {
			List<Long> keys = new ArrayList<>(keysSet.size());
			keys.addAll(keysSet);
			return Mono.fromCallable(() -> {
				Map<Long, GroupPage> map = new HashMap<>();
				// Values are returned in the same order as the keys list
				List<GroupPage> values = this.dataFetchersDelegateGroupPage.batchLoader(keys, env);
	...
	/**
	 * Loads the data for GroupPage.content. It is generated as the
	...
	public Map<GroupPage, List<Group>> content(BatchLoaderEnvironment batchLoaderEnvironment,
		...
		return this.dataFetchersDelegateGroupPage.content(batchLoaderEnvironment, graphQLContext, keys);
	}
