...
CREATE TABLE IF NOT EXISTS `declaration` (
  ...
  CONSTRAINT `FK_declaration_country` FOREIGN KEY (`country`) REFERENCES `country` (`alpha_2`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `person` (
  ...
  CONSTRAINT `FK_person_country` FOREIGN KEY (`country`) REFERENCES `country` (`alpha_2`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  CONSTRAINT `FK_user_country` FOREIGN KEY (`country`) REFERENCES `country` (`alpha_2`) ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT IGNORE INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `email`, `country`, `notes`) VALUES
