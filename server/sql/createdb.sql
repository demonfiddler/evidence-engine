...
CREATE TABLE IF NOT EXISTS `claim` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_claim_status_kind` (`status`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Claims, typically contrarian, made in respect of an associated topic, ';
...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  UNIQUE KEY `name` (`iso_name`) USING BTREE,
  CONSTRAINT `CC_numeric` CHECK (`numeric` regexp '^\\d{3}$')
...
CREATE TABLE IF NOT EXISTS `entity_kind` (
  `code` char(2) NOT NULL COMMENT 'Unique code for the entity kind',
...
CREATE TABLE IF NOT EXISTS `journal` (
  ...
  `issn` char(8) DEFAULT NULL COMMENT 'The International Standard Serial Number',
  ...
  CONSTRAINT `CC_issn` CHECK (`issn` regexp '^[0-9]{4}-[0-9]{3}[0-9X]$')
...
CREATE TABLE IF NOT EXISTS `log` (
  ...
  `transaction_kind` char(3) NOT NULL,
  `entity_kind` char(2) NOT NULL,
  `entity_id` int(10) unsigned NOT NULL,
  `linked_entity_kind` char(2) DEFAULT NULL,
  `linked_entity_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `person` (
  ...
  KEY `country` (`country_code`) USING BTREE,
  KEY `description` (`notes`(768)) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=2992 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='People who have publicly expressed contrarian/sceptical views about topic orthodoxy, whether by signing declarations, open letters or publishing science articles.';
...
) ENGINE=InnoDB AUTO_INCREMENT=341 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='References to published articles, peer-reviewed or otherwise.';
...
CREATE TABLE IF NOT EXISTS `publisher` (
  ...
  `url` varchar(200) DEFAULT NULL COMMENT 'URL of journal''s home page',
  ...
  `updated_by_user_id` int(10) unsigned DEFAULT NULL COMMENT 'ID of the user who last updated the record',
  PRIMARY KEY (`id`),
  UNIQUE KEY `publisher_fulltext` (`name`,`location`,`url`,`status`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=29696 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='A list of book, journal, etc. publishers. The table can contain duplicate entries in the name column, reflecting the same publisher in different locations.';
...
CREATE TABLE IF NOT EXISTS `quotation` (
  ...
  `author` varchar(50) NOT NULL COMMENT 'The quotation author (quotee)',
  ...
  FULLTEXT KEY `quotation_fulltext` (`author`,`text`,`source`,`url`,`notes`),
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Quotations by leading sceptics and contrarians';
...
CREATE TABLE IF NOT EXISTS `status_kind` (
  `code` char(3) NOT NULL DEFAULT '' COMMENT 'The status code',
  `label` varchar(20) NOT NULL DEFAULT '' COMMENT 'The status label',
...
CREATE TABLE IF NOT EXISTS `topic` (
  ...
  KEY `FKtopic_status_kind` (`status`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='A topic in a hierarchy of such topics, with arbitrary breadth and depth';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Association table that links topics to declarations';
...
CREATE TABLE IF NOT EXISTS `topic_person_ref` (
  ...
  KEY `topic_person_ref_topic_person` (`topic_id`,`person_id`),
...
CREATE TABLE IF NOT EXISTS `user` (
  `id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'The unique system-assigned user identifier',
  ...
  `updated_by_user_id` int(10) unsigned DEFAULT NULL COMMENT 'ID of the user who last updated the record',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_fulltext` (`login`,`first_name`,`last_name`,`email`,`notes`) USING HASH,
  ...
  CONSTRAINT `FK_user_updated_user` FOREIGN KEY (`updated_by_user_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE
