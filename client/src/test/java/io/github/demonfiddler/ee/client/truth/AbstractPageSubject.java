...
abstract class AbstractPageSubject<P extends AbstractPage<?>> extends Subject {

    final P actual;

    AbstractPageSubject(FailureMetadata failureMetadata, /*@Nullable*/ P actual) {
        super(failureMetadata, actual);
        this.actual = actual;
    }

    public abstract IterableSubject content();
