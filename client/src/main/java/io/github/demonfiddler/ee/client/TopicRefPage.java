 ...
 */
@GraphQLObjectType("TopicRefPage")
@JsonInclude(Include.NON_NULL)
public class TopicRefPage extends AbstractPage<TopicRef> {
	...
	@JsonDeserialize(using = CustomJacksonDeserializers.ListTopicRef.class)
	@GraphQLNonScalar(fieldName = "content", graphQLTypeSimpleName = "TopicRef", javaClass = TopicRef.class,
		listDepth = 1)
	List<TopicRef> content;
	...
	@JsonProperty("content")
	@Override
	public void setContent(List<TopicRef> content) {
	...
	@JsonProperty("content")
	@Override
	public List<TopicRef> getContent() {
		return this.content;
	}
	...
	static class Builder extends AbstractPage.AbstractBuilder<TopicRefPage, TopicRef> {

		Builder() {
		}

		@Override
		TopicRefPage createPage() {
			return new TopicRefPage();
		}
