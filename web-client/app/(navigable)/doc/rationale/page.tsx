  ...
  return (
    <article className="prose">
      ...
      <p>Mainstream narratives on certain key topics are frequently distorted by powerful geopolitical and commercial
        ...
        contradicting the official story are typically vilified, derided, cancelled, defunded, debanked, suspended,
        fired or even assassinated/'suicided'. Key human endeavours such as scientific research, education, journalism,
        policy making, governance and regulation are captured and controlled by these vested interests.</p>
      ...
      <ul>
        ...
        <li><b>Curate</b> high-quality contrarian scientific and other evidence, making it readily accessible to and
          reusable by researchers and activists;</li>
