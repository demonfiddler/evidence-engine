...
export default function StandardDetails(
  ...
  return (
    <>
      ...
      >
        <span className="text-lg"><ClipboardClockIcon className="inline" />&nbsp;{trackingDetailsOpen || !showLinkingDetails ? "Tracking" : "Tracking & Linking"}</span>
...
StandardDetails.whyDidYouRender = true